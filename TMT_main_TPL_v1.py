...
# Triplet-Loss Analysis (TPL) - Version 1
# Based on TMT_main_v3.py with modifications for Triplet Loss
#
#################################################
...
#################################################
# Load configuration
fname_cfg = 'config_LSO-TPL.yaml'  # LSO with Triplet Loss
...
if (cfg['model']['loss_type'] == 'CrossEntropy'):
    ...
    # For triplet/contrastive/circle loss, print validation loss and accuracy
    print('Val Loss:             % .3f' % trainer.logged_metrics['val_loss'])
    print('Val Acc:              % .3f' % trainer.logged_metrics['val_acc'])
print('--------------------------')
print()
print('>>> DONE !')
